...
async def evict_messages_and_recompile(
    ...
    if skip_sanity_check.strip().lower() != "sweep complete":
        ...
        if not found_memory_write:
            return (
                ...
                "Call again with skip_sanity_check=\"sweep complete\" to proceed anyway, or save your context first."
            )
